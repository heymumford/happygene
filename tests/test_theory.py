...
class TestNeutralDrift:
    ...
    def test_neutral_drift_fitness_variance_bounded(self):
        ...
        assert np.allclose(fitness_history, 1.0), \
        ...
        assert np.var(fitness_history) < 1e-10, \
...
class TestSelectionResponse:
    ...
    def test_proportional_selection_increases_mean_fitness(self):
        ...
        assert final_fitness >= 0.0, \
            f"Final fitness is negative: {final_fitness}"
...
class TestReproducibility:
    ...
    def test_same_seed_produces_identical_results(self):
        ...
        assert np.allclose(fitness_history_1, fitness_history_2), \
    ...
    def test_different_seeds_produce_different_results(self):
        ...
        for _ in range(30):
            network1.step()
            network2.step()
            expr1 = [gene.expression_level for ind in network1.individuals for gene in ind.genes]
            expr2 = [gene.expression_level for ind in network2.individuals for gene in ind.genes]
